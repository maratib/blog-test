...
const BlogMainCard: React.FC<IBlog> = ({ tags, title, readTime, date, image }) => {
  return (
    <>
      <div className="border-[13px] border-white bg-light-gray rounded-[32px] shadow-banner-card overflow-hidden">
        <div className="grid lg:grid-cols-2 2xl:min-h-[588px] lg:min-h-[441px] h-full">
          <div className="lg:h-full md:h-auto lg:py-0 h-[300px] relative md:py-40">
            <img src="/union-lines-3.svg" alt="Union lines" className="object-cover absolute top-0 inset-x-0 w-full" />
            <img src="/union-lines-3.svg" alt="Union lines" className="object-cover absolute bottom-0 inset-x-0 w-full transform rotate-180" />
            <img src={image} alt="mac-book" className="w-full h-full object-contain relative z-30" />
          </div>
